...
!(function () {
  ...
  const er = ['pre'].concat(['h1', 'h2', 'h3', 'h4', 'h5', 'h6']),
          ...
          (e, t) =>
            ((e) => -1 !== ' \f\t\v'.indexOf(e))(t) || t === pr
              ? e.pcIsSpace ||
                ...
                ((e, t) => t < e.length && t >= 0 && Zr(e[t]))(s, e.str.length + 1)
    ...
    ts = (e, t) =>
      ...
      ((e) =>
        yo(e) && 'A' === e.nodeName && !e.hasAttribute('href') && (e.hasAttribute('name') || e.hasAttribute('id')))(
        e
      ) ||
      ns(e),
      ...
      const a = Jo.forElement(mn(e), {contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy}),
        ...
        P = (t, n, o, r, s) =>
          T(t, (t) => {
            ...
            return (
              C(o) && B(a, o), r && (!m(r) && r.nodeType ? a.appendChild(r) : m(r) && D(a, r)), s ? a : t.appendChild(a)
            )
          }),
    ...
    da = () => {
      ...
      return {
        ...
        load: (e, o) => {
          ...
          0 !== s.indexOf('/') && -1 === s.indexOf('://') && (s = da.baseURL + '/' + s),
          ...
          (n = ((e) => {
            const t = [],
              ...
              o = (e, t) => {
                ...
                t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), ni(o) || n(si(ri(o), !1))),
                  t < e.data.length && (o.setStart(e, t), o.setEnd(e, t + 1), ni(o) || n(si(ri(o), !0)))
              },
              r = e.container(),
              s = e.offset()
  ...
  const ii = (e, t) => {
    ...
    mi = (e) => {
      ...
      e ? Oe(e.childNodes, (e, t) => (ci(t) && 'BR' !== t.nodeName ? (e = e.concat(fi(t))) : e.push(t), e), []) : [],
    gi = (e) => (t) => e === t,
    pi = (e) =>
  ...
  const bc = Io,
    ...
    Ec = (e, t, n) => {
      ...
      if (t.isEqual(ai.after(n)) && n.lastChild) {
        if (((a = ai.after(n.lastChild)), Zd(e) && wc(n.lastChild) && yc(n.lastChild)))
      ...
      if (o && ((Jd(e) && a.isAtEnd()) || (Zd(e) && a.isAtStart())) && ((o = tc(o, e, L, n, !0)), kc(o, n)))
        return _c(e, o)
      r = o ? tc(o, e, kc, n) : o
      const d = Be(
        K(
    ...
    Bc = (e, t, n) =>
      Tc(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !Oc(t, n) && ((o = t), !(!ai.isTextPosition(o) && Po(o.getNode()))) && Ac(t) && Rc(n)
            : !Oc(n, t) && Rc(t) && Ac(n)
          var o
        })(e, n, o)
          ? Tc(e, t, o)
    ...
    Wc = (e, t) =>
      Fc(e).fold(P, (e) => (t.setStart(e.container(), e.offset()), t.setEnd(e.container(), e.offset()), !0)),
    Kc = (e, t, n) =>
      !(
        !((e) => !e.hasChildNodes())(t) ||
        !jc(e, t) ||
          ...
          if (((e) => m(e.start))(t))
            return ((e, t) => {
              ...
              return Dt(n, o, (n, o) => {
                const r = e.createRng()
                return (
                  r.setStart(n.container(), n.offset()), r.setEnd(o.container(), o.offset()), {range: r, forward: Vc(t)}
                )
              })
            })(n, t)
          if (((e) => xe(e, 'id'))(t))
    ...
    nm = (e, t, n, o = !1) => {
      ...
      return (
        ...
        (Fu(d) || Uu(d)) &&
          ...
          Fu(d) && (l.isBlock(r) || (r = em(l, n, r, s, !0)), l.isBlock(a) || (a = em(l, n, a, i, !1)))),
  ...
  const cm = (e, t, n) =>
      !n.collapsed &&
      H(n.getClientRects(), (n) => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t)),
    um = (e, t, n) => {
      e.dispatch(t, n)
    },
    mm = (e, t, n, o) => {
  ...
  const Nm = (e, t, n, o) => ({start: e, soffset: t, finish: n, foffset: o}),
    ...
    Gm = (e) => {
      ...
      if (t === o && Ro(t)) {
        ...
        (Ro(t) && n > 0 && n < t.data.length && ((t = Km(t, n)), (n = 0)), Ro(o) && r > 0 && r < o.data.length)
      ) {
        const e = Km(o, r).previousSibling
        ;(o = e), (r = e.data.length)
      }
  ...
  const Tf = ta.DOM,
    ...
    Pf = (e, t) => {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        !e.activeEditor && Of && (Tf.unbind(document, 'focusin', Of), (Of = null))
    },
    Lf = (e, t) => {
      ;((e, t) =>
        ((e) => (e.collapsed ? M.from(za(e.startContainer, e.startOffset)).map(mn) : M.none()))(t).bind((t) =>
    ...
    isEmpty(e, t = {}, n) {
      ...
      if (s)
        do {
          ...
          if (3 === s.type && s.parent && t[s.parent.name] && Jr(null !== (o = s.value) && void 0 !== o ? o : ''))
            return !1
          if (n && n(s)) return !1
        } while ((s = Xf(s, r)))
      return !0
  ...
  const dg = ['font', 'text-decoration', 'text-emphasis'],
    ...
    tp = (e, t, n) => {
      ...
      return n || !Jg(o, o.length - 1) || Qg(e, r)
        ? !!(n && Zg(o, o.length - 1) && Xg(e, r)) && ((t.data = o.slice(0, -1) + pr), !0)
          ...
          ((e) => {
            const t = e.data,
              n = ((e) => {
                const t = e.split('')
                return $(t, (e, n) =>
                  eu(e) && n > 0 && n < t.length - 1 && nu(t[n - 1]) && nu(t[n + 1]) ? ' ' : e
                ).join('')
              })(t)
    ...
    lp = (e) => {
      return Gr(e.previousSibling)
        ? M.some(((t = e.previousSibling), Ro(t) ? ai(t, t.data.length) : ai.after(t)))
        : e.previousSibling
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome()
            ...
            : M.none()).orThunk(() => (n && (o.each((e) => sp(e.dom, e.dom.length)), r.each((e) => rp(e.dom, 0))), t))
        )
        var s, a, i, l
    ...
    Np = (e, t, n, o = !0) => {
      ...
      if (
        (a.dom === e.getBody() ? _p(e, o) : ss(a) && (kr(a), o && e.selection.setCursorLocation(a.dom, 0)), !bn(n, a))
      ) {
        const e = Bt(xn(a), n)
          ? []
          : xn((i = a))
    ...
    Hp = (e) => {
      ...
      Fo(n.dom) && ss(n) ? e.selection.setCursorLocation(n.dom, 0) : e.selection.collapse(!0),
              ...
              ss(o)
                ...
                : ((e, t, n, o, r) =>
                    Bc(n, e.getBody(), r).bind((e) =>
                      Kp(t, mn(e.getNode())).bind((e) => (bn(e, o) ? M.none() : M.some(S)))
                    ))(e, n, t, o, r)
            )
          })(e, t, o, n).orThunk(() =>
            Pt(
                  ...
                  Bc(n, e.getBody(), r).fold(
                    ...
                    (s) =>
                      ((e, t, n, o) =>
                        Ic(e.dom)
                          .bind((r) =>
                            Fc(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r)))
                          )
                          .getOr(!0))(o, n, r, s)
                        ? ((e, t) => Yp(e, t))(e, o)
                        : ((e, t, n) =>
      ...
      for (let l = 0; l < e.length; l++) {
        ...
        if (c && f.length > 1)
          if (t.isValidChild(c.name, d.name)) {
            ...
            lh(t, r, s, u) ? c.insert(d, f[0], !0) : (c.insert(u, f[0], !0), c.insert(d, u)),
              (c = f[0]),
    ...
    hh = (e, t, n, o) => {
      const r = ((e, t, n) => {
        ...
        a = fh(
          ((i = r.firstChild),
          K(null !== (l = null == i ? void 0 : i.childNodes) && void 0 !== l ? l : [], (e) => 'LI' === e.nodeName))
        )
      var i, l
      const d = t.getRoot(),
        c = (e) => {
      ...
      f === g &&
        ...
        a.isCollapsed() ||
          ((e) => {
            ...
            ;((e, t, n) => !!C(n) && n === e.getParent(t.endContainer, vh) && hu(mn(n), t))(t, n, o)
              ? qp(e, n, mn(o))
    ...
    xh = (e, t) =>
      ((e, t) => {
        const n = e.dom
        return n.parentNode
          ? ((e, t) => Q(e.dom.childNodes, (e) => t(mn(e))).map(mn))(mn(n.parentNode), (n) => !bn(e, n) && t(n))
          : M.none()
      })(e, t).isSome(),
    kh = (e) => (w(e) ? e : P),
    Sh = (e, t, n) => {
    ...
    Rh = (e, t, n) =>
      !(!zu(n) || !_h(t, n.inline)) || !(!Fu(n) || !_h(t, n.block)) || (!!Uu(n) && yo(t) && e.is(t, n.selector)),
    Ah = (e, t, n, o, r, s) => {
      const a = n[o],
        i = 'attributes' === o
  ...
  const Vh = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
    qh = (e, t) => {
      const n = e.get(t)
      return p(n)
        ? Q(n, (e) => zu(e) && 'span' === e.inline && ((e) => f(e.styles) && H(ue(e.styles), (e) => j(Vh, e)))(e))
        : M.none()
    },
    ...
    db = (e, t, n) => {
      ...
      return (
        Ro(o) && n && r >= o.data.length && (o = new Zo(o, e.getBody()).next() || o),
    ...
    hb = (e, t, n, o, r) => {
      ...
      if (zu(t) && 'all' === t.remove && p(l)) {
        ...
        if ((s.removeAllAttribs(i), V(e, (e) => s.setAttrib(i, e.name, e.value)), e.length > 0))
          ...
          ab(t.attributes, (e, o) => {
            ...
            if (t.remove_similar || h(l) || !yo(r) || ib(s.getAttrib(r, a), l)) {
              ...
              if (
                ...
                'style' === a && wo(['li'])(i) && 'none' === s.getStyle(i, 'list-style-type'))
              )
                return i.removeAttribute(a), void s.setStyle(i, 'list-style-type', 'none')
    ...
    vb = (e, t, n, o) =>
      hb(e, t, n, o, o).fold(N(o), (t) => (e.dom.createFragment().appendChild(o), e.dom.rename(o, t)), N(null)),
    yb = (e, t, n, o, r) => {
        ...
        u = (t) => {
          ...
          V(['underline', 'line-through', 'overline'], (n) => {
            yo(t) &&
              ...
              t.parentNode &&
              Lu(i, t.parentNode) === n &&
              bb(e, {deep: !1, exact: !0, inline: 'span', styles: {textDecoration: n}}, void 0, t)
          })
        },
        m = (e) => {
          ...
          if (t) {
            ...
            return (
              ((e) => Zc(e) && yo(e) && ('_start' === e.id || '_end' === e.id))(n) &&
        ...
        f = (t) => {
          ...
          if (a.split) {
            if (((r = Gm(r)), (n = db(e, r, !0)), (o = db(e, r)), n !== o)) {
              ...
              ;(n = ub(i, n, 'span', {id: '_start', 'data-mce-type': 'bookmark'})),
                (o = ub(i, o, 'span', {id: '_end', 'data-mce-type': 'bookmark'}))
              const e = i.createRng()
              e.setStartAfter(n),
                e.setEndBefore(o),
                om(i, e, (e) => {
                ...
                ? (zu(s) || (Fu(s) && s.wrapper)) &&
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    ;(Oh(e, s, n, o) && bb(e, t, o, r)) ||
                      (t.merge_with_parents && s && e.dom.getParent(s, (s) => !!Oh(e, s, n, o) && (bb(e, t, o, r), !0)))
                  })(e, s, t, n, a),
                  ((e, t, n, o) => {
    ...
    Rv = (function e() {
      ...
      var Ae = function (e) {
        ...
        Le = function (e) {
          return 'object' === Ab(i)
            ? e instanceof i
            : e && 'object' === Ab(e) && 'number' == typeof e.nodeType && 'string' == typeof e.nodeName
        },
        Me = function (e, t, o) {
          O[e] &&
            Kb(O[e], function (e) {
          ...
          return e instanceof l && !Ae(e)
            ...
            : ('noscript' !== o && 'noembed' !== o) || !tv(/<\/no(script|embed)/i, e.innerHTML)
              ? (X &&
                  ...
                  (t = Jb(t, D, ' ')),
                  (t = Jb(t, P, ' ')),
                  e.textContent !== t && (Yb(n.removed, {element: e.cloneNode()}), (e.textContent = t))),
        ...
        Fe = function (e, t, n) {
          ...
          if (G && !W[t] && tv(L, t));
            ...
            if (
              !(
                (Ue(e) &&
                  ((V.tagNameCheck instanceof RegExp && tv(V.tagNameCheck, e)) ||
                    (V.tagNameCheck instanceof Function && V.tagNameCheck(e))) &&
                  ((V.attributeNameCheck instanceof RegExp && tv(V.attributeNameCheck, t)) ||
                    (V.attributeNameCheck instanceof Function && V.attributeNameCheck(t)))) ||
                ('is' === t &&
                  V.allowCustomizedBuiltInElements &&
                  ((V.tagNameCheck instanceof RegExp && tv(V.tagNameCheck, n)) ||
  ...
  const Mv = (e, t, n) =>
    ...
    Fv = (e, t, n = !1) =>
      Mv(t, n, (t, n) => M.from(e.getByData(t, n)).orThunk(() => Dv(n, t).map((n) => Iv(e, n, t)))),
    Uv = Tt.each,
    zv = Tt.trim,
    jv = [
      'source',
      ...
      return (
        ...
        (!!/((java|vb)script|mhtml):/i.test(o) ||
          (!e.allow_html_data_urls &&
            (/^data:image\//i.test(o)
              ? ((e, t) => (C(e) ? !e : !C(t) || !j($v, t)))(e.allow_svg_data_urls, n) &&
  ...
  const Wv = Tt.makeMap,
                ...
                return [
                  (e) => {
                    ...
                    if (3 === e.type && !m(e)) {
                      ...
                      ;(n = n.replace(d, ' ')),
                        (((e, t) => C(e) && (e.name in t || 'br' === e.name))(e.prev, i) || f(e, !0)) &&
                          (n = n.replace(c, '')),
                  ...
                  (e) => {
                    ...
                    if (1 === e.type) {
                      ...
                      ;((e.next && i[e.next.name]) || f(e, !1)) && (t = t.replace(u, '')),
              ...
              w &&
                ...
                ((e, n) => {
                  ...
                  if (t.isValidChild(e.name, n.toLowerCase())) {
                    for (; i; ) {
                      const t = i.next
                      3 === i.type || (1 === i.type && 'p' !== i.name && !o[i.name] && !i.attr(Xv))
                        ? (l || ((l = new Zf(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)), l.append(i))
                        : (d(l), (l = null)),
                        (i = t)
                    }
                    d(l)
    ...
    Sy = (e, t, n) => {
      ...
      'fragmented' === t.type
        ...
        : e.setContent(t.content, {format: 'raw', no_selection: !C(o) || !$c(o) || !o.isFakeCaret}),
    ...
    Ty = (e) => ({
      ...
      undoManager: {
        ...
        redo: (t, n) =>
          ((e, t, n) => {
            ...
            return (
              t.get() < n.length - 1 &&
                (t.set(t.get() + 1), (o = n[t.get()]), Sy(e, o, !1), e.setDirty(!0), e.dispatch('Redo', {level: o})),
              o
            )
          })(e, t, n),
        clear: (t, n) =>
        ...
        closest: (t) =>
          ((e, t) => {
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) =>
                Sh(mn(o), (n) => ce(t, (t) => ((t, n) => (Oh(e, t.dom, n) ? M.some(n) : M.none()))(n, t)), n)
              )
              .getOrNull()
          })(e, t),
            ...
            ((e, t, n, o, r, s) => {
              ...
              V(n.split(','), (t) => {
                const n = we(a, t).getOrThunk(() => {
                    const e = {
                      withSimilar: {state: ra(!1), similar: !0, callbacks: []},
                      withoutSimilar: {state: ra(!1), similar: !1, callbacks: []},
                      withVars: []
                    }
                    return (a[t] = e), e
                  }),
      ...
      editor: {
        getContent: (t) =>
          ((e, t) => M.from(e.getBody()).fold(N('tree' === t.format ? new Zf('body', 11) : ''), (n) => rg(e, t, n)))(
            e,
            t
          ),
        setContent: (t, n) =>
  ...
  const Uy = (e) => !(!e || !e.ownerDocument) && vn(mn(e.ownerDocument), mn(e)),
    zy = (e, t, n, o) => {
      ...
      const {selectorChangedWithUnbind: a} = ((e, t) => {
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) => ((e, t, n) => Py(e).selection.getContent(t, n))(e, t.format ? t.format : 'html', t))(o, e),
          setContent: i,
    ...
    gC = (e, t) => {
      ...
      return $(t, (t) =>
        ((e) => /^[a-z0-9\-]+$/i.test(e))(t) && !e.inline ? `${n}/${t}/${o}` : e.documentBaseURI.toAbsolute(t)
      )
    },
    pC = L,
    hC = (e, t) => {
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        ze(o, 'blob:')
                          ...
                          Pv(t).then((o) => Mv(o, !1, (n) => M.some(Iv(e, t, n))).getOrThunk(n))
                        )
                  }
                  var o, r
                  return ze(t, 'data:')
      ...
      return (
          ...
          })(n, e),
        {
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) => Py(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: O(BC, e)
        }
      )
    },
                                ...
                                y(t)
                                  ...
                                  : e && Io(t.nextSibling)
                                    ...
                                    : !e && Io(t.previousSibling)
                                      ...
                                      : M.none())(t, n.getNode(!t)).orThunk(() => cw(e, t, n))
                            : cw(e, t, n).bind((t) =>
                                ((e, t, n) =>
                                  n.fold(
      ...
      e
        ? ((e) => {
            ...
            if (hw(e.previousSibling))
              return vw(e.previousSibling) || e.previousSibling.appendData(_r), e.previousSibling
    ...
    Lw = (e) => {
      return (
        ...
        !(
          ...
          ((e) => pp.test(e))(null !== (n = t.textContent) && void 0 !== n ? n : '')
        )
      )
      var t, n
    },
      ...
      for (; s; ) {
        ...
        if (Po(n.getNode(!1)))
          return t === hc.Forwards
            ? {positions: Ww(t, a).concat([n]), breakType: qw.Br, breakAt: M.some(n)}
  ...
  const mx = (e, t, n, o, r, s) => {
    ...
    Ax = (e, t, n) =>
      ...
      ((e, t) => {
        ...
        return (
          ...
          (e && Pr(o) ? Vw(!0, t.selection, o) : !(e || !Lr(o)) && Vw(!1, t.selection, o))
        )
      })(e, t),
    Ox = (e) => {
      const t = ra(null),
    ...
    $x = (e, t) =>
      (e || 'table' === Lt(t) ? 'margin' : 'padding') + ('rtl' === Vn(t, 'direction') ? '-right' : '-left'),
    Vx = (e) => {
      const t = Wx(e)
      return (
        !e.mode.isReadOnly() &&
    ...
    Wx = (e) => {
      return K(
        ...
        (e) => !qx(e) && !((e) => xn(e).exists(qx))(e) && Ko(e, (e) => Mo(e.dom) || Io(e.dom)).exists((e) => Mo(e.dom))
      )
      var t
    },
    Kx = (e, t) => {
    ...
    ok = (e) => {
      ...
      if (!o.isValidChild(u, c.toLowerCase()) || ((e, t, n) => H(Ng(mn(n), mn(t)), (t) => Zx(e, t.dom)))(r, a, s))
        return
      const m = n.getRng(),
    ...
    ik = (e, t) => {
      t.hasAttribute('data-mce-caret') &&
        (Fr(t), e.selection.setRng(e.selection.getRng()), e.selection.scrollIntoView(t))
    },
    lk = (e, t) => {
      const n = ((e) =>
    ...
    hk = (e, t) => {
      ...
      return ((e, t) => {
        ...
        if (
          ((e, t, n) =>
            t ? ((e, t) => ex(e, t).breakAt.isNone())(e.dom, n) : ((e, t) => Zw(e, t).breakAt.isNone())(e.dom, n))(
            n,
            t,
            o
          )
    ...
    Ck =
      ...
      () =>
        e.apply(null, t),
    wk = (e, t) =>
      Q(((e, t) => ee(((e) => $(e, (e) => ({...vk, ...e})))(e), (e) => (yk(e, t) ? [e] : [])))(e, t), (e) =>
        e.action()
      ),
    xk = (e, t) =>
      ce(((e, t) => ee(((e) => $(e, (e) => ({...vk, ...e})))(e), (e) => (yk(e, t) ? [e] : [])))(e, t), (e) =>
        e.action()
      ),
    kk = (e, t) => {
      const n = t ? hc.Forwards : hc.Backwards,
    ...
    Ik = (e, t, n) => {
      ...
      return ((e) => e.breakType === qw.Wrap && 0 === e.positions.length)(o) ||
        (!Po(n.getNode()) && ((e) => e.breakType === qw.Br && 1 === e.positions.length)(o))
    ...
    Yk = (e, t) => {
      ...
      return ((e, t) =>
        ((e, t, n = P) =>
          n(t) ? M.none() : j(e, Lt(t)) ? M.some(t) : Go(t, e.join(','), (e) => pn(e, 'table') || n(e)))(
          ['td', 'th'],
          e,
          t
        ...
        () =>
          ((e, t, n, o = 0) => {
            ...
            return nS(
              ...
              if ((r.setStart(e.container, e.offset), r.setEnd(t.endContainer, t.endOffset), r.collapsed))
                return M.none()
              const s = oS(r)
  ...
  const uS = (e, t, n) => (e.stype === cS.Error ? t(e.serror) : n(e.svalue)),
        ...
        we(o, e).fold(
          ...
          (e) =>
            ((e, t, n, o) =>
              we(n, o).fold(
                () =>
                  ((e, t, n) => hS(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + pS(t)))(
                    e,
                    n,
                    o
                  ),
      ...
      switch (e.tag) {
        case 'required':
          return ((e, t, n, o) =>
            we(t, n).fold(
              () =>
                ((e, t, n) => hS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + pS(n)))(
                  e,
                  n,
                  t
                ),
    ...
    AS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) => (e.stype === cS.Error ? {stype: cS.Error, serror: t(e.serror)} : e))(t.extract([e], n), (e) => ({
            input: n,
            errors: e
          })))(e, t, n)),
    ...
    WS = (e, t, n) =>
      VS(
        ...
        ((e) => {
          return (
            (t = (t) =>
              j(e, t) ? Oi.value(t) : Oi.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`)),
            kS((e) => t(e).fold(fS, mS))
          )
          var t
        })(n)
  ...
  const b_ = (e) => {
    ...
    L_ = {
      insert: (e, t) => {
        ...
        if (
          ('LI' !== x || b || ((w = s), (s = s.parentNode), (r = x)), /^(LI|DT|DD)$/.test(r) && yo(s) && i.isEmpty(w))
        )
          return void ((e, t, n, o, r) => {
            ...
            if (R_(n, o, !0) && R_(n, o, !1))
              ...
              __(n, 'LI')
                ? (s.insertAfter(d, N_(n)), d.appendChild(s.doc.createTextNode(' ')), d.appendChild(n))
                : i.insertBefore(d, n),
                s.remove(o)
        ...
        if (Or(w)) (S = Fr(w)), i.isEmpty(w) && O_(w), P_(e, S), x_(e, S)
          ...
          const t = ((e) => {
            const t = e.cloneRange()
            return (
              t.setStart(e.startContainer, D_(!0, e.startContainer, e.startOffset)),
              ...
              t.isDefaultPrevented() ||
                ((e, t) => {
                  xk([{keyCode: bm.SPACEBAR, action: Ck(mE, e)}], t).each((n) => {
                    t.preventDefault(),
                      w_(e, 'insertText', {data: ' '}).isDefaultPrevented() || (n(), C_(e, 'insertText', {data: ' '}))
                  })
                })(e, t)
            })
          })(e),
  ...
  const hE = N('x-tinymce/html'),
    ...
    zE = (e, t, n) => {
      ;((e, t, n) => {
        let o
        e.on('keydown', (e) => {
          ;((e) => (bm.metaKeyPressed(e) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode))(e) &&
            !e.isDefaultPrevented() &&
  ...
  const sN = (e, t) => Math.abs(e.left - t),
        ...
        return ((e, t, n, o) => {
          const r = (t, s) =>
            s
              ...
              .orThunk(() => {
                var n
                return (bn(t, e) ? M.none() : ((n = t), M.from(n.dom.parentElement).map(mn))).bind((e) =>
                  r(e, M.some(t))
                )
              })
          return r(t, M.none())
      ...
      const l = (e) => e !== o && (SN(e) || zo(e)) && n.isChildOf(e, o),
        ...
        m = (t) => {
          const o = e.schema.getVoidElements(),
            ...
            l = t.endOffset
          return (
            xe(o, s.nodeName.toLowerCase()) ? (0 === a ? r.setStartBefore(s) : r.setStartAfter(s)) : r.setStart(s, a),
        ...
        f = (r, c) => {
          ...
          const g = r.endOffset
          if (
            (Ro(m) && 0 === f && SN(m.parentNode) && ((m = m.parentNode), (f = n.nodeIndex(m)), (m = m.parentNode)),
            !yo(m))
          )
            return null
          ...
          e.on('mousedown', (r) => {
            ...
            SN(a)
              ...
              : cN(o, r.clientX, r.clientY).each((n) => {
                  var o
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === rN.Before, !1)) && t.setRng(o),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(), 'drop' === t.type && cC(e, 'Dropped file type is not supported'))
                      }
                    },
                    n = (n) => {
                      Bf(e, n.target) && t(n)
    ...
    ON = (e, t) => {
      ...
      return x(o)
        ? Y(n, (e, t) => e.bind((e) => M.from(e.childNodes[t])), M.some(e)).bind((e) =>
            Ro(e) && (o < 0 || o > e.data.length) ? M.none() : M.some({node: e, offset: o})
          )
        : M.none()
    },
    TN = (e, t) =>
    ...
    DN = (e, t, n, o = !0) => {
      ...
      t.deleteContents(),
        o &&
          !n(t.startContainer) &&
          (Ro(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer),
    ...
    VN = (e, t, n, o) => {
      ...
      return eS(i, l - n.pattern.end.length, t).bind((d) => {
        ...
        if (HN(a)) return M.some({matches: [{pattern: a, startRng: c, endRng: c}], position: d})
        {
          ...
          return m.map((e) => {
            const t = ((e, t, n, o = !1) => AN(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(
              r,
              s,
              e,
              o
              ...
              return ((e, t) => {
                ...
                .map((e) =>
                  Tt.trim(i).length === e.start.length
                    ? []
                    : [{pattern: e, range: AN(s, s.getRoot(), t, 0, t, 0, true)}]
                )
                .getOr([])
            })(e, o, a)
          return (
                ...
                e.execCommand('mceInsertNewLine'),
                  n.each((t) => {
                    ...
                    n.data.charAt(t.offset - 1) === gr &&
                      (n.deleteData(t.offset - 1, 1), BN(e.dom, n.parentNode, (t) => t === e.dom.getRoot()))
                  })
              }
            ),
            !0)
    ...
    aR = (e) => {
      ...
      ;(o.disabled = !0),
        (e.readonly = Kl(e)),
        e.readonly ||
          (e.inline && 'static' === JN.getStyle(o, 'position', !0) && (o.style.position = 'relative'),
          ...
          ((e) => {
            ;((e) => {
              const t = [',', '.', ';', ':', '!', '?'],
                ...
                o = () => {
                  return (
                    (t = yd(e)), (n = Cd(e)), {inlinePatterns: Mi(t), blockPatterns: Li(t), dynamicPatternsLookup: n}
                  )
                  var t, n
                },
        ...
        ((e) => {
          ...
          if (m(t)) {
            ...
            ;(e.theme = n(e, iC.urls[t]) || {}),
              w(e.theme.init) && e.theme.init(e, iC.urls[t] || e.documentBaseUrl.replace(/\/$/, ''))
          } else e.theme = {}
        })(e),
        ((e) => {
          const t = Bl(e),
              ...
              ;((e, t) => {
                ...
                ;(r.onload = () => {
                  ...
                  (e.iframeHTML = ((e) => {
                    ...
                    Ki(e) !== e.documentBaseUrl && (t += '<base href="' + e.documentBaseURI.getURI() + '" />'),
                ...
                t.editorContainer &&
                  ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = lR.isHidden(t.editorContainer))),
    ...
    NR = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = Yg(o, ai.fromRangeStart(t)) ? n.replace(/^ /, '&nbsp;') : n.replace(/^&nbsp;/, ' ')),
                ...
                e.removed ||
                  (t
                    ...
                    : ((e) => {
                        ...
                        e.inline || (Nt.browser.isOpera() || Mf(n), e.getWin().focus()),
                          (Nt.browser.isFirefox() || e.inline) && (Mf(n), Lf(e, o)),
                          Ff(e)
                      })(e))
              })(e, !0 === o)
            },
      ...
      dA(cA(e.toLowerCase(), '+'), (e) => {
        ;((e) => e in mA)(e)
          ...
          : /^[0-9]{2,}$/.test(e)
            ...
            : ((t.charCode = e.charCodeAt(0)), (t.keyCode = uA[e] || e.toUpperCase().charCodeAt(0)))
      })
      const o = [t.keyCode]
      let r
  ...
  class yA {
      ...
      ;(this.options = ((e, t) => {
        const n = {},
          ...
          r = (e, t, n) => {
            ...
            return sA(r)
              ? ((o[e] = r.value), !0)
              : (console.warn(rA(`Invalid value passed for the ${e} option`, r)), !1)
          },
          s = (e) => xe(n, e)
        return {
          register: (e, s) => {
        ...
        ((e) => {
          ...
          t('id', {processor: 'string', default: e.id}),
            ...
            e.on('ScriptsLoaded', () => {
              t('directionality', {processor: 'string', default: la.isRtl() ? 'rtl' : void 0}),
                t('placeholder', {processor: 'string', default: zi.getAttrib(e.getElement(), 'placeholder')})
            })
        })(o)
    ...
    render() {
      ;((e) => {
        ...
        s &&
          ...
          jl(e) &&
            !No(e.getElement()) &&
            (fR.insertAfter(fR.create('input', {type: 'hidden', name: t}), t), (e.hasHiddenInput = !0)),
    ...
    getParam(e, t, n) {
      ...
      return (
        o.isRegistered(e) ||
          (C(n) ? o.register(e, {processor: n, default: t}) : o.register(e, {processor: L, default: t})),
    ...
    show() {
      ...
      e.hidden &&
        ((e.hidden = !1),
        e.inline ? (e.getBody().contentEditable = 'true') : (hA.show(e.getContainer()), hA.hide(e.id)),
        e.load(),
        e.dispatch('show'))
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (hA.hide(e.getContainer()), hA.setStyle(e.id, 'display', e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch('hide'))
    }
    isHidden() {
    ...
    resetContent(e) {
      void 0 === e ? Vy(this, this.startContent, {format: 'raw'}) : Vy(this, e),
  ...
  const _A = (e) => {
    ...
    NA = (e) => {
      ...
      return (
        (SA = K(SA, (t) => e !== t)),
        AA.activeEditor === e && (AA.activeEditor = SA.length > 0 ? SA[0] : null),
    ...
    AA = {
          ...
          CA.unbind(window, 'ready', s),
            ...
            Tt.each(i, (e) => {
              ...
              ;(n = t.get(e.id)) &&
                ...
                (NA(n), n.unbindAllNativeEvents(), n.destroy(!0), (n.removed = !0))
            }),
            ...
            return (
              ...
              h(t.get(n.id))
                ...
                : (NA(n) && t.dispatch('RemoveEditor', {editor: n}),
                  0 === SA.length && window.removeEventListener('beforeunload', xA),
                  n.remove(),
                  EA(SA.length > 0),
                  n)
            )
      ...
      _setBaseUrl(e) {
        ;(this.baseURL = new qv(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, ''))),
    ...
    MA = {
      ...
      clamp: (e, t, n) => {
        ...
        const i = t.x + t.w,
          ...
          m = BA(0, a - l)
        return (
          (o += d), (r += c), n && ((s += d), (a += c), (o -= u), (r -= m)), (s -= u), (a -= m), LA(o, r, s - o, a - r)
        )
      },
      create: LA,

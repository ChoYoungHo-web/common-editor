  ...
  const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
    ...
    W = (e, t, n, o, r) => {
      ...
      if (
        ((e, t) =>
          ...
          R(e, t) ||
          ((e, t) =>
            'true' === e.getContentEditable(t) && t.parentNode && 'false' === e.getContentEditableParent(t.parentNode))(
            e,
            t
          ))(e, n)
      )
    ...
    te = (e, t, n) => {
      ...
      for (let e = 0; e < a.length; e++) {
        ...
        null !== t &&
          t.length &&
          (t === s.index.toString() && (o || (o = a[e].firstChild), (r = a[e].firstChild)), K(a[e]))
      }
        ...
        d = (e) => {
          ...
          if (o.findtext.length) {
            if (r.text === o.findtext && r.matchCase === o.matchcase && r.wholeWord === o.wholewords) X(t, n)
              ...
              r <= 0 &&
                ((e) => {
                  t.windowManager.alert('Could not find the specified string.', () => {
                    e.focus('findtext')
                  })
                })(e),
                a(e, 0 === r)

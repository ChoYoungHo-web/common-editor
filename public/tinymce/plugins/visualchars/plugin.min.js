...
!(function () {
          ...
          : 'object' === e && Array.isArray(t)
            ...
            : 'object' === e &&
                ...
                (s = String).prototype.isPrototypeOf(n) ||
                  (null === (r = o.constructor) || void 0 === r ? void 0 : r.name) === s.name)
              ? 'string'
              : e
        var n, o, s, r
      })(t),
  ...
  const c = (t) => t.dom.nodeValue,
    ...
    N = 'mce-nbsp',
    C = (t) => '<span data-mce-bogus="1" class="mce-' + y[t] + '">' + t + '</span>',
    T = (t) => {
      const e = c(t)
    ...
    B = (t) => 'span' === t.nodeName.toLowerCase() && t.classList.contains('mce-nbsp-wrap'),
    S = (t, e) => {
      const n = t.dom,
        o = O(f(e), T)
      i(o, (e) => {
        ...
        if (B(s))
          ...
          const s = n.encode(null !== (o = c(e)) && void 0 !== o ? o : '').replace(A, C),
            r = n.create('div', {}, s)
          let a
    ...
    _ = ('visualchars_default_state', (t) => t.options.get('visualchars_default_state'))
  const j = (t, e) => {
      const n = ((t, e) => {
        let n = null
        return {
    ...
    return (
      ...
      ((t, e) => {
        ...
        t.ui.registry.addToggleButton('visualchars', {
          tooltip: 'DescriptionItem invisible characters',
          icon: 'visualchars',
          onAction: n,
          onSetup: x(t, e)
        }),
          t.ui.registry.addToggleMenuItem('visualchars', {
            text: 'DescriptionItem invisible characters',
            icon: 'visualchars',
            onAction: n,
            onSetup: x(t, e)
          })

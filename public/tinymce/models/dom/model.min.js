...
!(function () {
  ...
  const Z = (e) => e.dom.nodeName.toLowerCase(),
    ...
    et = (e) => {
      ...
      return ((e) => {
        ...
        var o
      })(pe.fromDom(t)).fold(() => o.body.contains(t), ((n = et), (r = Ze), (e) => n(r(e))))
      var n, r
    },
    tt = (e) => {
      const t = e.dom.body
  ...
  var lt = (e, t, o, n, r) => (e(o, n) ? C.some(o) : d(r) && r(o) ? C.none() : t(o, n, r))
  const at = (e, t, o) => {
      let n = e.dom
      const r = d(o) ? o : y
      for (; n.parentNode; ) {
    ...
    ht = (e, t, o) => '' === t || (e.length >= t.length && e.substr(o, o + t.length) === t),
    pt = (e, t, o = 0, n) => {
    ...
    Lt = g(10),
    _t = (e, t) => Mt(e, t, x),
    Mt = (e, t, o) => j(Ee(e), (e) => (we(e, t) ? (o(e) ? [e] : []) : Mt(e, t, o))),
    jt = (e, t) =>
      ((e, t, o = y) => (o(t) ? C.none() : D(e, Z(t)) ? C.some(t) : ct(t, e.join(','), (e) => we(e, 'table') || o(e))))(
        ['td', 'th'],
        e,
        t
      ),
    It = (e) => _t(e, 'th,td'),
    Pt = (e) => (we(e, 'colgroup') ? rt(e, 'col') : j(qt(e), (e) => rt(e, 'col'))),
    Ft = (e, t) => dt(e, 'table', t),
    Ht = (e) => _t(e, 'tr'),
    ...
    eo = [
      {
        ...
        search: (e) => pt(e, 'edge/') && pt(e, 'chrome') && pt(e, 'safari') && pt(e, 'applewebkit')
      },
      {
        name: 'Chromium',
        brand: 'Chromium',
      ...
      {name: 'Opera', versionRegexes: [Xt, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: Zt('opera')},
      {name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: Zt('firefox')},
      {
        name: 'Safari',
        versionRegexes: [Xt, /.*?cpu os ([0-9]+)_([0-9]+).*/],
        search: (e) => (pt(e, 'safari') || pt(e, 'mobile/')) && pt(e, 'applewebkit')
      }
    ],
    to = [
      {name: 'Windows', search: Zt('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/]},
      {
        name: 'iOS',
      ...
      {name: 'Android', search: Zt('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/]},
      {name: 'macOS', search: Zt('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/]},
      ...
      {name: 'ChromeOS', search: Zt('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/]}
    ],
    ...
    xo = vo,
    Co = (g(uo), g('iOS'), g(fo), g(go), g(ho), g(po), g(wo), g(bo), (e) => window.matchMedia(e).matches)
  let So = Gt(() =>
    ((e, t, o) => {
      const n = oo.browsers(),
        r = oo.oses(),
  ...
  const To = () => So(),
    ...
    On = {delta: (e, t) => Dn(t).delta(e, t), positions: (e, t) => Dn(t).positions(e, t), edge: (e) => Dn(e).edge(e)},
    kn = {
      unsupportedLength: [
        'em',
        'ex',
    ...
    zn = ae('col'),
    An = (e, t, o) => {
      const n = ((r = e), C.from(r.dom.parentElement).map(pe.fromDom)).getOrThunk(() => tt(Se(e)))
      var r
      return (t(e) / o(n)) * 100
    },
    Wn = (e, t) => {
    ...
    Jn = (e, t, o, n) => {
      const r = tn(e),
        ...
        l = [C.some(On.edge(t))].concat(E(On.positions(r, t), (e) => e.map((e) => e.x))),
        a = b(Bt)
      return E(s, (e, t) =>
        Yn(
          e,
    ...
    Rr = (e) => ({col: vr(e), colgroup: yr(e), row: xr(e), cell: br(e), replace: Sr, colGap: vr(e), gap: br(e)}),
  ...
  var Pr = [
    ...
    Fr = () => ({
      ...
      insert: g({before: Be, after: ze, afterAll: _e, append: We, appendAll: Me, prepend: Ae, wrap: Le}),
      remove: g({unwrap: Pe, remove: Ie}),
      create: g({nu: pe.fromTag, clone: (e) => pe.fromDom(e.dom.cloneNode(!1)), text: pe.fromText}),
      query: g({comparePosition: (e, t) => e.dom.compareDocumentPosition(t.dom), prevSibling: Oe, nextSibling: ke}),
      property: g({
        children: Ee,
        name: Z,
        parent: Re,
  ...
  const Hr = (e, t, o, n) => {
    ...
    Vr = Fr(),
    $r = (e, t) =>
      ((e, t, o) => (o.length > 0 ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, Hr) : C.none()))(
        Vr,
        (t, o) => e(o),
        t
      ),
    ...
    Gr = (e, t, o) => {
      ...
      return ye(e, t)
        ...
        : Ur(e).bind((r) =>
            Ur(t).bind((s) => {
              if (ye(r, s)) return C.some({boxes: Mr(r, e, t), start: e, finish: t})
              if (xe(r, s)) {
              ...
              return ((e, t, o) =>
                ...
                dt(l, 'table', o).bind((o) => {
                  ...
                  return C.some({boxes: jr(o, e, r, t, s), start: i, finish: a})
                })
              )
            })
          )
    ...
    Yr = (e, t, o) =>
      mt(e, t).bind((t) => mt(e, o).bind((e) => $r(Ur, [t, e]).map((o) => ({first: t, last: e, table: o})))),
    Jr = (e, t, o, n, r) =>
      ((e, t) => L(e, (e) => we(e, t)))(e, r).bind((e) =>
        ((e, t, o) =>
          ...
          ((e, t) =>
            ct(e, 'table').bind((o) =>
              mt(o, t).bind((t) =>
                Gr(t, e).bind((e) => e.boxes.map((t) => ({boxes: t, start: e.start, finish: e.finish})))
              )
            ))(e, n)
        )
      ),
                    ...
                    Wr(e, t, o).bind((t) =>
                      ((e, t) => {
                        ...
                        for (let r = t.startRow; r <= t.finishRow; r++)
                          for (let s = t.startCol; s <= t.finishCol; s++) o = o && Ko(e, r, s).exists(n)
    ...
    es = (e) => {
      ...
      return e.length > 0 && I(e, (e) => t(e, 'rowspan') || t(e, 'colspan')) ? C.some(e) : C.none()
    },
    ts = (e, t, o) =>
      t.length <= 1
        ? C.none()
        : Xr(e, o.firstSelectedSelector, o.lastSelectedSelector).map((e) => ({bounds: e, cells: t})),
    os = {
    ...
    ns = (e, t, o) => ({element: o, mergable: ts(t, e, os), unmergable: es(e), selection: Zr(e)}),
    rs = (e) => (t, o) => {
      const n = Z(t),
        r =
          'col' === n || 'colgroup' === n
              ...
              Ft(e[0]).map((e) => {
                const t = ((e, t) => {
                      ...
                      for (let e = 0; e < l; e++) {
                        ...
                        for (let a = 0; a < s; a++)
                          e < o.minRow ||
                            ...
                            a < o.minCol ||
                            a > o.maxCol ||
                            (Ko(t, e, a).filter(n).isNone() ? lr(r, l, e) : (l = !0))
                      }
                    })(r, l, a, o)
                  const m = ((e, t, o, n) => {
                    ...
                    const r = Xn(t, e, o),
                      s = W(r, (e, t) => e + t, 0),
                      l = W(r.slice(n.minCol, n.maxCol + 1), (e, t) => e + t, 0),
                  ...
                  return (
                    ((e, t, o, n) => {
                      G(o.columns, (e) => {
                        ;(e.column < t.minCol || e.column > t.maxCol) && Ie(e.element)
                      })
                      const r = z(_t(e, 'tr'), (e) => 0 === e.dom.childElementCount)
                      N(r, Ie),
    ...
    ms = (e, t, o) =>
      (e.property().isText(t) && 0 === e.property().getText(t).trim().length) || e.property().isComment(t)
        ...
        : C.none(),
    ds = (e, t) => (e.property().isText(t) ? e.property().getText(t).length : e.property().children(t).length),
    us = (e, t) => {
          ...
          In(e).bind((e) => {
            return (
              ...
              C.from(En.exec(t)).bind((e) => {
                const t = Number(e[1]),
                  n = e[2]
                return ((e, t) => O(t, (t) => O(kn[t], (t) => e === t)))(n, o) ? C.some({value: t, unit: n}) : C.none()
              })
            )
            var t, o
          }))(e)
    ...
    Os = (e) => {
      const t = 'thead' === e.section,
        o = ut(ks(e.cells), 'th')
      return 'tfoot' === e.section ? {type: 'footer'} : t || o ? {type: 'header', subType: Ds(t, o)} : {type: 'body'}
    },
    ks = (e) => {
    ...
    As = () => ({transformRow: (e, t) => Ns(e, 'thead' === t ? 'tbody' : t), transformCell: Es}),
    Ws = Bs,
    Ls = zs,
    _s = As,
    Ms = () => ({transformRow: h, transformCell: Es}),
    js = (e) => dt(e, '[contenteditable]'),
    Is = (e, t = !1) => (et(e) ? e.dom.isContentEditable : js(e).fold(g(t), (e) => 'true' === Ps(e))),
    ...
    qs = (e, t) => {
      const o = [],
        ...
        s = (e) => j(e, (e) => E(e.cells, (e) => (Fs(e.element, 'span', e.colspan, 1), e.element))),
        l = (t, o) => {
          const n = ((e, t) => {
              const o = it(e, t).getOrThunk(() => {
                const o = pe.fromTag(t, Se(e).dom)
                return (
                  'thead' === t ? Hs(e, 'caption,colgroup', o) : 'colgroup' === t ? Hs(e, 'caption', o) : We(e, o), o
                )
              })
              return je(o), o
            })(e, o),
          ...
          if (!1 === o[r][s]) {
            const m = ((e, t, o, n) => {
              const r = ((e, t) => e[t])(e, t),
                ...
                a = s ? 1 : Vs(((e, t) => E(e, (e) => Lo(e, t)))(e.slice(t), o), n)
      ...
      return t(i, l)
        .map((t) => {
          const o = ((e, t) => Us(e, t, !1))(i, a),
            n = e(o, t, ye, r(a), m),
            s = Ho(n.grid)
          return {info: t, grid: Gs(n.grid), cursor: n.cursor, lockedColumns: s}
        })
        .bind((e) => {
          const t = qs(s, e.grid),
    ...
    Qs = (e, t) => Ys(e, t, x).map((e) => ({cells: e, generators: t.generators, clipboard: t.clipboard})),
    Xs = (e, t) => Ys(e, t, x),
    Zs = (e, t) => Ys(e, t, (e) => !e.isLocked),
    el = (e, t) => I(t, (t) => ((e, t) => Ks(e, t).exists((e) => !e.isLocked))(e, t)),
    tl = (e, t, o, n) => {
      const r = jo(e).rows
      let s = !0
    ...
    rl = {value: ol, error: nl, fromOption: (e, t) => e.fold(() => nl(t), ol)},
    ...
    gl = (e, t, o, n, r) => {
      ;((e, t, o, n) => {
        const r = jo(e).rows
        if (t > 0 && t < r.length) {
          const e = ((e, t) => W(e, (e, o) => (O(e, (e) => t(e.element, o.element)) ? e : e.concat([o])), []))(
            r[t - 1].cells,
            o
          )
          N(e, (e) => {
    ...
    wl = (e, t, o, n) =>
      ((e, t, o, n) => void 0 !== _o(e[t], o) && t > 0 && n(_o(e[t - 1], o), _o(e[t], o)))(e, t, o, n) ||
      ((e, t, o) => t > 0 && o(_o(e, t - 1), _o(e, t)))(e[t], o, n),
    bl = (e, t, o, n) => {
      const r = (e) => (((e) => ('row' === e ? zt(t) : Bt(t)))(e) ? `${e}group` : e)
      return e ? (Ts(t) ? r(o) : null) : n && Ts(t) ? r('row' === o ? 'col' : 'row') : null
    },
    ...
    Cl = (e, t, o, n, r) => {
      const s = jo(e).rows,
        l = j(t, (e) => xl(s, e, n)),
        a = E(s, (e) => Rs(e.cells)),
        c = ((e, t) => (I(t, h) && Rs(e) ? x : (e, o, n) => !('th' === Z(e.element) && t[o])))(l, a),
        i = (
          (e, t) => (o, n) =>
    ...
    Nl = (e) =>
      W(e, (e, t) => (O(e, (e) => e.column === t.column) ? e : e.concat([t])), []).sort((e, t) => e.column - t.column),
    Bl = ae('col'),
    zl = ae('colgroup'),
    Al = (e) => 'tr' === Z(e) || zl(e),
    Wl = (e) => ({element: e, colspan: Et(e, 'colspan', 1), rowspan: Et(e, 'rowspan', 1)}),
    Ll = (e) => ue(e, 'scope').map((e) => e.substr(0, 3)),
    _l = (e, t = Wl) => {
      const o = (o) => {
        if (Al(o)) return zl((r = {element: o}).element) ? e.colgroup(r) : e.row(r)
        {
          const r = o,
      ...
      unmerge: (t) => {
        ...
        return (
          ...
          () => {
            ...
            return kt(n, 'width'), kt(t, 'width'), o.each((e) => ie(n, 'scope', e)), n
          }
        )
      },
      merge: (e) => (
    ...
    ql = (e) => {
      const t = ae('br'),
            ...
            .bind((o) => {
              const n = ke(o)
                .map(
                  (e) =>
                    !!Fl(e) ||
                    (!!((e, t) => D(['br', 'img', 'hr', 'input'], e.property().name(t)))(Pl, e) && 'img' !== Z(e))
                )
                .getOr(!1)
              return Re(o).map((r) => {
                return !0 === n || 'li' === Z((s = r)) || at(s, Hl).isSome() || t(o) || (Fl(r) && !ye(e, r))
                  ? []
                  : [pe.fromTag('br')]
                var s
              })
        ...
        n = (() => {
          const n = j(e, (e) => {
            const n = Ee(e)
            return ((e) => I(e, (e) => t(e) || (re(e) && 0 === cr(e).trim().length)))(n) ? [] : n.concat(o(e))
          })
    ...
    Kl = (e) => W(e, (e, t) => (O(e, (e) => e.row === t.row) ? e : e.concat([t])), []).sort((e, t) => e.row - t.row),
    Yl = (e, t) => (o, n, r, s, l) => {
      const a = Kl(n),
        c = E(a, (e) => e.row),
        i = ((e, t, o, n, r, s, l) => {
          ...
          const f = [...a, ...u],
            g = ((e, t) => (I(t, h) && Rs(e.cells) ? x : (e, o, n) => !('th' === Z(e.element) && t[n])))(i, d),
            p = (
              (e, t) => (o, n, r) =>
    ...
    na = (e, t) => O(t, (t) => t.column + t.colspan >= e.grid.columns && t.isLocked),
    ra = (e, t) => {
      const o = tn(e),
        n = Nl(t)
    ...
    ia = Js(
      (e, t, o, n) => {
        const r = t[0].row,
          s = Kl(t),
          l = A(s, (e, t) => ({grid: hl(e.grid, r, t.row + e.delta, o, n.getOrInit), delta: e.delta + 1}), {
            grid: e,
            delta: 0
          }).grid
    ...
    da = Js(
      (e, t, o, n) => {
        const r = t.details,
          s = Nl(r),
          l = s[0].column,
          a = A(s, (e, t) => ({grid: pl(e.grid, l, t.column + e.delta, o, n.getOrInit), delta: e.delta + 1}), {
            grid: e,
            delta: 0
          }).grid
    ...
    Ta = Js(
        ...
        return ((e, t, o, n, r) => {
          const s = Ho(t),
            l = ((e, t, o) => {
              ...
              return {row: r, column: L(s, (e) => I(o, (t) => t !== e)).getOr(n - 1)}
            })(e, t, s),
            a = jo(o).rows,
            c = ul(l, a, s),
            i = ((e, t, o) => {
              if (e.row >= t.length || e.column > Mo(t[0]))
                return rl.error('invalid start address out of table bounds, row: ' + e.row + ', column: ' + e.column)
              const n = t.slice(e.row),
                r = n[0].cells.slice(e.column),
                s = Mo(o[0]),
                l = o.length
              return rl.value({rowDelta: n.length - l, colDelta: r.length - s})
            })(l, t, a)
          return i.map((e) => {
      ...
      (e, t) =>
        jt(t.element).bind((o) => Ks(e, o).map((e) => ({...e, generators: t.generators, clipboard: t.clipboard}))),
      ea,
      f,
      _l
    ),
      ...
      return Xs(o, t)
        .bind((e) => {
          const t = e[e.length - 1],
            ...
            s = M(E(o.all, (e) => z(e.cells, (e) => e.column >= n && e.column < r)))
          return ks(s)
        })
        .getOr('')
    },
    ...
    Xa = (e) => {
      ...
      return t.isSet('table_default_attributes')
        ? o
        : ((e, t) => (Ya(e) || Qa(e) ? t : Ka(e) ? {...t, width: Pa(e)} : {...t, width: Ia}))(e, o)
    },
        ...
        a =
          ...
          (i, m, d = !1) => {
            ...
            const u = pe.fromDom(e.getDoc()),
              f = Tr(a, u, r),
              g = {sizing: ec(e, i), resize: $a(e) ? xs() : Cs(), section: l(i)}
            return s(i)
              ? n(i, m, f, g).bind((n) => {
                  t.refresh(i.dom),
                    N(n.newRows, (t) => {
                      ...
                      () => {
                        ...
                        return H(n)
                          ...
                          .map((n) => {
                            ...
                            return r.selectNode(n.dom), e.selection.setRng(r), ie(n, 'data-mce-selected', '1'), r
                          })
                      },
                      (n) => {
                        const r = fs(gs, n),
                  ...
                  return et(i) && (kr(i), d || Wa(e, i.dom, c)), r.map((e) => ({rng: e, effect: c}))
                })
              : C.none()
          },
    ...
    rc = Tl([{invalid: ['raw']}, {pixels: ['value']}, {percent: ['value']}]),
    sc = (e, t, o) => {
    ...
    lc = {
      ...rc,
      from: (e) => (bt(e, '%') ? sc('%', rc.percent, e) : bt(e, 'px') ? sc('px', rc.pixels, e) : rc.invalid(e))
    },
    ac = (e, t, o) => {
      const n = lc.from(o),
        r = I(e, (e) => '0px' === e)
    ...
    cc = (e, t) => (0 === e.length ? t : A(e, (e, t) => lc.from(t).fold(g(0), h, h) + e, 0)),
    ic = (e, t) =>
      lc.from(e).fold(
        g(e),
        (e) => e + t + 'px',
    ...
    mc = (e) => {
      ...
      const t = A(
        ...
        o = t.output
      return o.slice(0, o.length - 1).concat([ic(o[o.length - 1], Math.round(t.remainder))])
    },
    dc = lc.from,
    ...
    xc = {styles: {'border-collapse': 'collapse', width: '100%'}, attributes: {border: '1'}, colGroups: !1},
    Cc = (e, t, o, n) =>
      k(e, (e) =>
        ((e, t, o, n) => {
          ...
          for (let s = 0; s < e; s++) {
            ...
            s < o && ie(e, 'scope', 'row'), n < t && ie(e, 'scope', 'col'), We(e, pe.fromTag('br')), We(r, e)
          }
          return r
        })(t, o, n, e)
      ),
    ...
    Tc = (e, t, o, n, s) => {
      ...
      return (
        ...
        mt(Dr(e), 'table[data-mce-id="__mce"]')
          .map(
            (t) => (
              Ka(e) ? vc(t) : Ya(e) ? yc(t) : (Ga(e) || ((e) => r(e) && -1 !== e.indexOf('%'))(l.width)) && bc(t),
              kr(t),
              fe(t, 'data-mce-id'),
              ((e, t) => {
                N(st(t, 'tr'), (t) => {
  ...
  const Dc = 'x-tinymce/dom-table-',
    ...
    Ic = (e, t) => {
      const o = Or(e),
        n = (e) => Ft(e, o),
        l = (t) => ((e) => ls(Er(e), Or(e)))(e).bind((e) => n(e).map((o) => t(o, e))),
        a = (t) => {
          e.focus()
        },
        c = (t, o = !1) =>
          ...
          l((t, o) =>
            ((e, t, o) => {
              ...
              return Xs(n, t)
                .bind((e) => {
                  const t = Us(n, o, !1),
                    r = jo(t).rows.slice(e[0].row, e[e.length - 1].row + e[e.length - 1].rowspan),
                    s = j(r, (e) => {
                  ...
                  E(e, (e) => {
                    ...
                    return (
                      N(e.cells, (e) => {
                        ...
                        Fs(o, 'colspan', e.colspan, 1), Fs(o, 'rowspan', e.rowspan, 1), We(t, o)
                      }),
                      t
                    )
                  })
          ...
          o().each((o) => {
            ...
            l((o, r) => {
              const s = Rr(pe.fromDom(e.getDoc())),
                l = ((e, t, o, n) => ({selection: Zr(e), clipboard: o, generators: n}))(as(e), 0, n, s)
              t(o, l).each(a)
            })
          }),
        g = (e) => (t, o) =>
      ...
      G(
        {
          ...
          mceTableDelete: () =>
            jc(e).each((t) => {
              Ft(t, o)
                ...
                .each((t) => {
                  const o = pe.fromText('')
                  if ((ze(t, o), Ie(t), e.dom.isEmpty(e.getBody()))) e.setContent(''), e.selection.setCursorLocation()
                  else {
          ...
          mceTableCellToggleClass: (t, o) => {
            l((t) => {
              const n = as(e),
                r = I(n, (t) => e.formatter.match('tablecellclass', {value: o}, t.dom)),
                s = r ? e.formatter.remove : e.formatter.apply
              N(n, (e) => s('tablecellclass', {value: o}, e.dom)), Wa(e, t.dom, La)
            })
          },
          mceTableToggleClass: (t, o) => {
            l((t) => {
              e.formatter.toggle('tableclass', {value: o}, t.dom), Wa(e, t.dom, La)
            })
          },
            ...
            jc(e).each((t) => {
              Ft(t, o).each((o) => {
                it(o, 'caption').fold(
                  ...
                  (n) => {
                    ae('caption')(t) && ve('td', o).each((t) => e.selection.setCursorLocation(t.dom, 0)), Ie(n)
                  }
                ),
                  Wa(e, o.dom, _a)
              })
    ...
    Pc = Tl([{before: ['element']}, {on: ['element', 'offset']}, {after: ['element']}]),
    Fc = {
      before: Pc.before,
      on: Pc.on,
      after: Pc.after,
    ...
    Yc = Tl([{ltr: ['start', 'soffset', 'finish', 'foffset']}, {rtl: ['start', 'soffset', 'finish', 'foffset']}]),
    Jc = (e, t, o) => t(pe.fromDom(o.startContainer), o.startOffset, pe.fromDom(o.endContainer), o.endOffset),
    Qc = (e, t) => {
      const o = ((e, t) =>
        t.match({
          domRange: (e) => ({ltr: g(e), rtl: C.none}),
          relative: (t, o) => ({ltr: Gt(() => Uc(e, t, o)), rtl: Gt(() => C.some(Uc(e, o, t)))}),
          exact: (t, o, n, r) => ({ltr: Gt(() => Gc(e, t, o, n, r)), rtl: Gt(() => C.some(Gc(e, n, r, t, o)))})
        }))(e, t)
      return ((e, t) => {
        const o = t.ltr()
        return o.collapsed
          ? t
              ...
              .map((e) => Yc.rtl(pe.fromDom(e.endContainer), e.endOffset, pe.fromDom(e.startContainer), e.startOffset))
  ...
  const Zc = (e, t, o, n) => ({start: e, soffset: t, finish: o, foffset: n}),
    ...
    ti = (e, t) => {
      const o = Xc(e, t)
      return Zc(pe.fromDom(o.startContainer), o.startOffset, pe.fromDom(o.endContainer), o.endOffset)
    },
    oi = ei,
    ni = (e, t, o, n, r) =>
      ye(o, n)
        ...
        : Gr(o, n, t).bind((t) => {
            ...
            return n.length > 1 ? (r(e, n, t.start, t.finish), C.some(Hc(C.some(oi(o, 0, o, dr(o))), !0))) : C.none()
          }),
    ...
    ii = (e, t, o, n, r = ci) =>
      L(r, (e) => e.current === o).bind((o) =>
        o.current(e, t, n, o.next).orThunk(() => o.fallback.bind((o) => ii(e, t, o, n)))
      ),
    mi = (e, t, o, n, r, s) =>
      ii(e, t, n, r).bind((t) => (s(t.item) ? C.none() : o(t.item) ? C.some(t.item) : mi(e, t.item, o, t.mode, r, s))),
    ...
    wi = Tl([{none: ['message']}, {success: []}, {failedUp: ['cell']}, {failedDown: ['cell']}]),
    bi = (e) => dt(e, 'tr'),
    vi = {
      ...wi,
    ...
    yi = ae('br'),
    xi = (e, t, o) => t(e, o).bind((e) => (re(e) && 0 === cr(e).trim().length ? xi(e, t, o) : C.some(e))),
    Ci = (e, t, o, n) =>
      ((e, t) =>
        Ne(e, t)
          .filter(yi)
    ...
    Si = (e, t) => ({left: e.left, top: e.top + t, right: e.right, bottom: e.bottom + t}),
    Ti = (e, t) => ({left: e.left, top: e.top - t, right: e.right, bottom: e.bottom - t}),
    Ri = (e, t, o) => ({left: e.left + t, top: e.top + o, right: e.right + t, bottom: e.bottom + o}),
    Di = (e) => ({left: e.left, top: e.top, right: e.right, bottom: e.bottom}),
          ...
          ? ((e, t, o) =>
              o >= 0 && o < dr(t)
                ...
                : o > 0
                  ...
                  : C.none())(e, t, o).map(Di)
          : C.none(),
    Ei = (e, t) => (ne(t) ? Oi(e, t).map(Di) : re(t) ? e.getRangedRect(t, 0, t, dr(t)).map(Di) : C.none()),
    Ni = Tl([{none: []}, {retry: ['caret']}]),
    Bi = (e, t, o) => {
      return ((n = t), (r = Fl), lt((e, t) => t(e), at, n, r, undefined)).fold(y, (t) =>
        Ei(e, t).exists((e) => ((e, t) => e.left < t.left || Math.abs(t.right - e.left) < 1 || e.left > t.right)(o, e))
      )
      var n, r
    },
    zi = {
        ...
        : ((e, t, o) =>
          ...
          : e.situsFromPoint(n.left, t.point(n)).bind((s) =>
              s.start.fold(
                ...
                (s) =>
                  Ei(e, s)
                    .bind((l) => t.adjuster(e, s, l, o, n).fold(C.none, (n) => Ai(e, t, o, n, r - 1)))
                    .orThunk(() => C.some(n)),
                C.none
              )
            ),
      ...
      e.getSelection().bind((n) =>
        ((e, t, o, n) => {
          ...
          (r) => {
            ...
            return (
              (l = vi.verify(e, n.finish, n.foffset, s.finish, s.foffset, o.failure, t)),
              vi.cata(
                l,
                (e) => C.none(),
                () => C.none(),
      ...
      0 === s
        ...
        : Pi(e, t, o, n, r).bind((l) => {
            ...
            return vi.cata(
              ...
              () => C.none(),
              () => C.some(l),
              (l) => (ye(o, l) && 0 === n ? ji(e, o, n, Ti, r) : Mi(e, t, l, 0, r, s - 1)),
              (l) => (ye(o, l) && n === dr(l) ? ji(e, o, n, Si, r) : Mi(e, t, l, dr(l), r, s - 1))
            )
          }),
    ji = (e, t, o, n, r) => ki(e, t, o).bind((t) => Ii(e, r, n(t, Li.getJumpSize()))),
    Ii = (e, t, o) => {
      const n = To().browser
    ...
    Fi = (e, t, o, n, r) =>
      dt(n, 'td,th', t).bind((n) =>
        dt(n, 'table', t).bind((s) =>
          ((e, t) => at(e, (e) => Re(e).exists((e) => ye(e, t)), void 0).isSome())(r, s)
            ? ((e, t, o) => _i(e, t, o).bind((n) => Mi(e, t, n.element, n.offset, o, 20).map(e.fromSitus)))(
                e,
                t,
                o
              ).bind((e) => dt(e.finish, 'td,th', t).map((t) => ({start: n, finish: t, range: e})))
            : C.none()
        )
      ),
    Hi = (e, t, o, n, r, s) =>
    ...
    qi = (e, t) =>
      dt(e, 'tr', t).bind((e) =>
        dt(e, 'table', t).bind((o) => {
          const n = st(o, 'tr')
          return ye(e, n[0])
            ? ((e, t, o) => ui(gi, e, (e) => hr(e).isSome(), o))(o, 0, t).map((e) => {
                const t = dr(e)
      ...
      dt(e, 'tr', t).bind((e) =>
        dt(e, 'table', t).bind((o) => {
          ...
          return ye(e, n[n.length - 1])
            ? ((e, t, o) => fi(gi, e, (e) => gr(e).isSome(), o))(o, 0, t).map((e) => Hc(C.some(oi(e, 0, e, 0)), !0))
            : C.none()
        })
      ),
    $i = (e, t, o, n, r, s, l) => Fi(e, o, n, r, s).bind((e) => ni(t, o, e.start, e.finish, l)),
    Ui = (e) => {
      let t = e
      return {
        get: () => t,
    ...
    Ki = (e, t) => dt(e, 'td,th', t),
    Yi = {traverse: ke, gather: pi, relative: Fc.before, retry: Li.tryDown, failure: vi.failedDown},
    Ji = {traverse: Oe, gather: hi, relative: Fc.before, retry: Li.tryUp, failure: vi.failedUp},
    Qi = (e) => (t) => t === e,
    Xi = Qi(38),
    Zi = Qi(40),
    em = (e) => e >= 37 && e <= 40,
    ...
    sm = document.caretPositionFromPoint
      ? (e, t, o) => {
          var n, r
          return C.from(
            null === (r = (n = e.dom).caretPositionFromPoint) || void 0 === r ? void 0 : r.call(n, t, o)
          ).bind((t) => {
    ...
    lm = (e, t) => {
      const o = Z(e)
      return 'input' === o ? Fc.after(e) : D(['br', 'img'], o) ? (0 === t ? Fc.before(e) : Fc.after(e)) : Fc.on(e, t)
    },
    ...
    fm = (e) => {
      if (e.rangeCount > 0) {
        ...
        return C.some(Zc(pe.fromDom(t.startContainer), t.startOffset, pe.fromDom(o.endContainer), o.endOffset))
      }
      return C.none()
    },
    gm = (e) => {
    ...
    pm = (e) =>
      ((e) =>
        am(e)
          ...
          .bind(gm))(e).map((e) => rm.exact(e.start, e.soffset, e.finish, e.foffset)),
    wm = (e) => ({
        ...
        ((e, t, o) =>
          ((e, t, o) => {
            ...
            return sm(n, t, o).map((e) =>
              Zc(pe.fromDom(e.startContainer), e.startOffset, pe.fromDom(e.endContainer), e.endOffset)
            )
          })(e, t, o))(e, t, o).map((e) => ei(e.start, e.soffset, e.finish, e.foffset)),
      clearSelection: () => {
        ;((e) => {
      ...
      const t = pe.fromDom(
          ((e) => {
            if (Qe() && m(e.target)) {
              ...
              if (ne(t) && m(t.dom.shadowRoot) && e.composed && e.composedPath) {
    ...
    zm = (e, t) => {
      const o =
          ...
          {get: () => Qr(pe.fromDom(e.getBody()), r).fold(() => ls(Er(e), Or(e)).fold(Sm, Rm), Tm)}),
        n = ((e, t, o) => {
          const n = (t) => {
          ...
          return {
            ...
            clear: s,
            selectRange: (o, n, l, a) => {
              s(o), N(n, r), ie(l, e.firstSelected, '1'), ie(a, e.lastSelected, '1'), t(n, l, a)
            },
      ...
      return (
        e.on('init', (o) => {
                    ...
                    g = Kr(t, n.selectedSelector).fold(
                      ...
                      (e) => {
                        const o = (o) => () => {
                          const s = V(o, (o) =>
                            ((e, t, o, n, r) =>
                              Jr(n, e, t, r.firstSelectedSelector, r.lastSelectedSelector).map(
                                (e) => (r.clearBeforeUpdate(o), r.selectRange(o, e.boxes, e.start, e.finish), e.boxes)
                              ))(o.rows, o.cols, t, e, n)
                          )
                          return s.fold(
                            () =>
                              Yr(t, n.firstSelectedSelector, n.lastSelectedSelector).map((e) => {
                                const o = Zi(u) || m.isForward(u) ? Fc.after : Fc.before
                                return (
                                  r.setRelativeSelection(Fc.on(e.first, 0), o(e.table)), n.clear(t), Hc(C.none(), !0)
                                )
                              }),
                  ...
                  Kr(t, n.selectedSelector).fold(() => {
                    ...
                    return !0 === c.shiftKey && em(i)
                      ? ((e, t, o, n, r, s, l) =>
                          ye(o, r) && n === s
                            ? C.none()
                            : dt(o, 'td,th', t).bind((o) => dt(r, 'td,th', t).bind((n) => ni(e, t, o, n, l))))(
                          t,
                          o,
                          r,
                          s,
              ...
              return {
                touchEnd: (o) => {
                  ...
                  if (ae('td')(n) || ae('th')(n)) {
                    const r = e.get(),
                      s = t.get()
                    ye(r, n) && o.timeStamp - s < 300 && (o.preventDefault(), i(n, n))
                  }
          ...
          e.on('dragstart', (e) => {
            ...
            e.on('mouseover', (e) => {
              var t
              ;(void 0 !== (t = e).buttons && 0 == (1 & t.buttons)) || !Bm(e) || a.mouseover(Nm(e))
            }),
            e.on('mouseup', (e) => {
        ...
        e.on('PreInit', () => {
          e.serializer.addTempAttr(os.firstSelected), e.serializer.addTempAttr(os.lastSelected)
        }),
        {
          getSelectedCells: () =>
            ((e, t, o, n) => {
    ...
    Wm = (e) => ({registry: K(e, (e) => ({bind: e.bind, unbind: e.unbind})), trigger: K(e, (e) => e.trigger)}),
    Lm = (e) => e.slice(0).sort(),
    _m = (e, t) => {
      const o = z(t, (t) => !D(e, t))
      o.length > 0 &&
            ...
            (n) => {
              ...
              return (
                s.length > 0 &&
                  ((e, t) => {
                    throw new Error(
                      'All values need to be of type: ' + t + '. Keys (' + Lm(e).join(', ') + ') were not.'
                    )
                  })(s, o.label),
                n
              )
    ...
    sink: (e, t) => {
      const o = ((e) => {
          ...
          return (
            ...
            Tt(o, {position: 'fixed', left: '0px', top: '0px', width: '100%', height: '100%'}),
            xm(o, qm('blocker')),
            xm(o, t.layerClass),
            {
              element: g(o),
  ...
  const $m = Hm('ephox-snooker').resolve,
      ...
      ;((e, t, o, n) => {
        Jm(e, t, (e, t) => {
          const r = ((e, t, o, n, r) => {
            ...
            return (
              Tt(s, {position: 'absolute', left: t + 'px', top: o - 3.5 + 'px', height: '7px', width: n + 'px'}),
      ...
      ;((e, t, o, n) => {
        Jm(e, t, (e, t) => {
          const r = ((e, t, o, n, r) => {
            const s = pe.fromTag('div')
            return (
              Tt(s, {position: 'absolute', left: t - 3.5 + 'px', top: o + 'px', height: r + 'px', width: '7px'}),
    ...
    nd = (e) => {
      ...
      o.events.stop.bind(() => {
        t.get().each((t) => {
          n.each((o) => {
            r(t, 'data-row').each((e) => {
              const n = s(t, 'top')
              fe(t, 'data-initial-top'), d.trigger.adjustHeight(o, n, parseInt(e, 10))
            }),
              r(t, 'data-column').each((e) => {
                const n = s(t, 'left')
                fe(t, 'data-initial-left'), d.trigger.adjustWidth(o, n, parseInt(e, 10))
              }),
              Xm(e, o)
          })
        })
      ...
      const l = (n, r) => {
        ...
        c = Em(e.parent(), 'mousedown', (e) => {
          var t
          ;(t = e.target), Cm(t, Gm) && l(e.target, 'top'), ((e) => Cm(e, Km))(e.target) && l(e.target, 'left')
        }),
        i = (t) => ye(t, e.view()),
    ...
    rd = (e, t, o) => {
      const n = Rn,
        r = On,
        s = nd(e),
        l = Wm({beforeResize: Am(['table', 'type']), afterResize: Am(['table', 'type']), startDrag: Am([])})
      return (
        s.events.adjustHeight.bind((e) => {
          ...
          ;((e, t, o, n) => {
            const r = Uo(e),
              s = ((e, t, o) => Zn(e, t, o, Hn, (e) => e.getOrThunk(Lt)))(r, e, n),
    ...
    cd = (e) => {
      ...
      return (
        e.on('init', () => {
          const r = ((e, t) =>
            e.inline
              ? ((e, t, o) => ({parent: g(t), view: g(e), origin: g(dn(0, 0)), isResizable: o}))(
                  pe.fromDom(e.getBody()),
                  (() => {
                    const e = pe.fromTag('div')
                    return (
                      Tt(e, {position: 'static', height: '0', width: '0', padding: '0', margin: '0', border: '0'}),
              ...
              : ((e, t) => {
                  const o = se(e) ? ((e) => pe.fromDom(Te(e).dom.documentElement))(e) : e
                  return {parent: g(o), view: g(e), origin: g(dn(0, 0)), isResizable: t}

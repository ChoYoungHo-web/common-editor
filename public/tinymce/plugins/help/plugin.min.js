            ...
            : 'object' === t && Array.isArray(e)
              ...
              : 'object' === t &&
                  ...
                  (a = String).prototype.isPrototypeOf(n) ||
                    (null === (i = o.constructor) || void 0 === i ? void 0 : i.name) === a.name)
                ? 'string'
                : t
          var n, o, a, i
        })(e))
      ...
      const t = (e) => `<a href="${e.url}" target="_blank" rel="noopener">${e.name}</a>`,
        ...
        o = (e) => {
          const t = ((e) => {
            ...
            r = a.length,
            l = a.join('')
          return '<p><b>' + x.translate(['Plugins installed ({0}):', r]) + '</b></p><ul>' + l + '</ul>'
        },
        a = {
          type: 'htmlpanel',
          presets: 'document',
          html: [
            ((e) => (null == e ? '' : '<div data-mce-tabstop="1" tabindex="-1">' + o(e) + '</div>'))(e),
            (() => {
        ...
        const o = A(),
          ...
          l = (() => {
            ...
            const n =
              ...
              ((e = C.majorVersion), (t = C.minorVersion), (0 === e.indexOf('@') ? 'X.X.X' : e + '.' + t) + '</a>')
            return {
              name: 'versions',
              title: 'Version',
              items: [
                {type: 'htmlpanel', html: '<p>' + x.translate(['You are using {0}', n]) + '</p>', presets: 'document'}
              ]
            }
          })(),
            ...
            ((e, t) => {
              const o = {},
                a = p(e, (e) => {
                  ...
                  {
                    const t = null !== (a = e.name) && void 0 !== a ? a : n('tab-name')
                    return (o[t] = e), t
                  }
                })

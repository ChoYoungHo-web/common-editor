...
!(function () {
  ...
  const o = (e) => (t) => t.options.get(e),
    ...
    g = (e, o, i) => {
      ...
      C < 0 && (C = 0)
      const S = e.getContainer().offsetHeight - e.getContentAreaContainer().offsetHeight
      C + S > p && (h = C + S)
      const z = s(e)
      if ((z && h > z ? ((h = z), l(e, !0)) : l(e, !1), h !== o.get())) {
        ...
        e.hasFocus() &&
          ...
          (t.browser.isSafari() || t.browser.isChromium()) && n < 0 && g(e, o, i)
      }
    }
  e.add('autoresize', (e) => {
    if (
        ...
        ((e, t) => {
          e.on('init', () => {
            ...
            o.setStyles(e.getDoc().documentElement, {height: 'auto'}),
              o.setStyles(e.getBody(), {paddingLeft: t, paddingRight: t, 'min-height': 0})
          }),

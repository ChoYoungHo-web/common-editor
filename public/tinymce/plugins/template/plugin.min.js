...
!(function () {
  ...
  const c = (e) => (t) => t.options.get(e),
    ...
    M = (e, t, a = new Date()) => {
      ...
      return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
        '%D',
        '%m/%d/%Y'
      )).replace('%r', '%I:%M:%S %p')).replace('%Y', '' + a.getFullYear())).replace('%y', '' + a.getYear())).replace(
        '%m',
        b(a.getMonth() + 1, 2)
      )).replace('%d', b(a.getDate(), 2))).replace('%H', '' + b(a.getHours(), 2))).replace(
        '%M',
        '' + b(a.getMinutes(), 2)
      )).replace('%S', '' + b(a.getSeconds(), 2))).replace('%I', '' + (((a.getHours() + 11) % 12) + 1))).replace(
        '%p',
        a.getHours() < 12 ? 'AM' : 'PM'
      )).replace('%B', '' + e.translate(l[a.getMonth()]))).replace('%b', '' + e.translate(s[a.getMonth()]))).replace(
        '%A',
  ...
  const x = Object.hasOwnProperty,
    ...
    w = (e) =>
      e.replace(/["'<>&]/g, (e) => {
        return ((t = S), (a = e), ((e, t) => x.call(e, t))(t, a) ? T.from(t[a]) : T.none()).getOr(e)
        var t, a
      }),
    C = (e, t, a) =>
      ((a, n) => {
    ...
    O = (e, t) => (
      o.each(t, (t, a) => {
        s(t) && (t = t(a)),
          (e = e.replace(new RegExp('\\{\\$' + a.replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '\\}', 'g'), t))
      }),
      e
    ),
    A = (e, t) => {
              ...
              if (-1 === t.indexOf('<html>')) {
                ...
                const l = _(e),
                  ...
                  i =
                    ...
                    (I.os.isMacOS() || I.os.isiOS() ? 'e.metaKey' : 'e.ctrlKey && !e.altKey') +
